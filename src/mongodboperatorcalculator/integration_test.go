...
func TestNoAutoscaling(t *testing.T) {
	...
	conf.Init()
	var c MongoDBOperatorCalculator
	c.Init(ConfigurationRequest{DBType: DbTypeReplicaSet, Dimension: Dimension{Id: 1}, LoadType: LoadType{Id: 4}, Connections: 100000, MongoDBVersion: Version{7, 0, 0}}, conf)
